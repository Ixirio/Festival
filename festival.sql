...
--
-- Hôte : localhost:3306
-- Généré le : mar. 14 déc. 2021 à 15:06
...
CREATE TABLE `candidature` (
  ...
  `TYPE_SCENE` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `NOM_REP` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `PRENOM_REP` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ADRESSE_REP` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `POSTAL_REP` int(100) NOT NULL,
  `MAIL_REP` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `TEL_REP` int(100) NOT NULL,
  `STYLE` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ANNEE_CREATION` int(100) NOT NULL,
  ...
  `SITE_FACEBOOK` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `SOUNDCLOUD` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `YOUTUBE` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NB_MEMBRES` int(100) NOT NULL,
  `NOM_MEMBRE_1` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `PRENOM_MEMBRE_1` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `INSTRUMENT_MEMBRE_1` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `NOM_MEMBRE_2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PRENOM_MEMBRE_2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `INSTRUMENT_MEMBRE_2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NOM_MEMBRE_3` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PRENOM_MEMBRE_3` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `INSTRUMENT_MEMBRE_3` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NOM_MEMBRE_4` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PRENOM_MEMBRE_4` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
